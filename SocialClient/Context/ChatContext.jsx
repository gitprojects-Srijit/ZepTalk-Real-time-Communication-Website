...
export const ChatProvider = ({children}) => {
    ...
    // funtion to get messages from users
    ...
    // Create function to subscribe to new message for selected user
    ...
    //create a function to unsubscribe to messages
    const unsubscribeToNewMessage = () =>{
        if(socket){
